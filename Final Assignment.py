...
tesla_htmldata=requests.get(url).text
...
soup=BeautifulSoup(tesla_htmldata,"html.parser")
...
soup2=BeautifulSoup(game_html,"html.parser")
...
gme_revenue["Revenue"]=gme_revenue["Revenue"][gme_revenue["Revenue"]!=""]
